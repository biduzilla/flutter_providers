    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Dismissible(key: UniqueKey(), background: Container(color: Colors.red,),child: ListTile(leading: Icon(clients[index].type.icon),
          title: Text(clients[index].name) + '('+clients[index].type.name + ')',iconColor: Colors.indigo,)
          ,)
        },
      ),
    );
